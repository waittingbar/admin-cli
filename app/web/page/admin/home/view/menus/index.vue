<template>
  <div>
      ...
      <el-dialog width="600px" title="新增菜单" :close-on-click-modal="false" :visible.sync="dialogFormVisible">
...
export default {
  ...
  methods: {
    getMenuList(json) {
      this.loading = true;
      $request.get(`/admin/api/menus/list?pageIndex=${json.pageIndex}&pageSize=${json.pageSize}&name=${json.name}`).then(res=> {
